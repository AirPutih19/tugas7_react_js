...
import { Alert, Badge, Breadcrumb, Button, ButtonGroup, Card, CardGroup, Col, Container, Image, Row } from "react-bootstrap";
  ...
  render(){
    return(
      <div>
        <Container fluid>
          <Row>
            <Col sm={2}><Alert variant="primary">Website React Bootsrap</Alert></Col>
            <Col sm={6}></Col>
            <Col>
            <ButtonGroup>
          ...
          <ButtonGroup>
            <Button variant="light"><Image src="https://banner2.kisspng.com/20180420/kuq/kisspng-computer-icons-user-clip-art-my-vector-5ad9a348cd2ce1.8035052415242125528404.jpg" width={30} height={30}/> Andreas</Button>
          </ButtonGroup>
          </Col>
          </Row>
          <Row>
            ...
            <Card style={{ width: '300px' }}>
              ...
              <Card style={{ width: '300px' }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Gelandang tim nasional (timnas) Indonesia U-23, Sani Rizki Fauzi, menegaskan kesepiannya untuk bermain pada laga melawan Brunei Darussalam U-23. Kedua tim akan bentrok pada laga pamungkas grup K
                  </Card.Text>
                  <Button variant="primary">Read More</Button>
                </Card.Body>
              </Card>
